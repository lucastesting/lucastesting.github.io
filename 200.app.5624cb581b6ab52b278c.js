...
/***/ function(module, exports, __webpack_require__) {
  ...
  var body = exports.body = _react2.default.createElement(
    ...
    _react2.default.createElement(
      "p",
      null,
      "The place did not disappoint, everything we tried was delicious from the Spanish ham and croquettes to the not-so-traditional perfectly cooked little steak bites, with delightful sangria to wash it all down. I think my stand-out favourite was the little sandwiches with",
      _react2.default.createElement(
        "a",
        { href: "/images/sobrasada_de_bellota.jpg" },
        "sobrasada"
      ),
      " (basically spreadable chorizo) and melted cheese. Spreadable meat seems like it should be a bit wrong, but it tasted fantastic. I'm told that when ",
      _react2.default.createElement(
        "a",
        { href: "/images/sturicho.jpg" },
        "sturicho"
      ),
      " was visiting he loved the stuff too; Ibby said he probably would have brushed his teeth with the stuff if he could have :P"
    ),
    _react2.default.createElement(
      "p",
      null,
    ...
    _react2.default.createElement(
      "p",
      null,
      "I just love all the clean complexity of all the shapes involved, with so much of it coming from fairly simple math and geometry concepts. The columns for example are ",
      _react2.default.createElement(
        "a",
        { href: "http://www.sagradafamilia.cat/sf-eng/docs_instit/geometria1.php" },
        "double twisted"
      ),
      ", meaning that they have twice as many \"sides\" at their tops than they do at the bottom, and there's no sudden point where this shape change takes place. There was a video of the machine they used to produce them and it was mesmerizing to watch. ",
      _react2.default.createElement(
        "a",
        { href: "http://www.sagradafamilia.cat/sf-eng/docs_instit/geometria1.php" },
        "The whole geometry section"
      ),
      " of the official site is worth checking out if you like that kind of stuff."
    ),
