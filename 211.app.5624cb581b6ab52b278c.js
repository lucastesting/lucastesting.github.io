...
/***/ function(module, exports, __webpack_require__) {
  ...
  var body = exports.body = _react2.default.createElement(
    ...
    _react2.default.createElement(
      "p",
      null,
      "The last stop for us in Uganda (for this entry at least), was at Lake Bunyonyi where we stayed at a very scenic camp ground next to a very large and interesting lake. It has nearly 30 islands, its surface is nearly 2000 metres above sea level, and it's stupidly deep. ",
      _react2.default.createElement(
        "a",
        { href: "http://en.wikipedia.org/wiki/Lake_Bunyonyi" },
        "Wikipedia says it's rumoured to be between 44 metres (which seems like it should be shallow enough to prove or disprove) and 900 meters (now we're talking!)"
      ),
      ". The was a sign on the bank that claims it's 6,500 feet deep, or about 2000 meters, and since Wikipedia only lists \"rumoured depths\", I'm going with that since the sign is more of a citation than the Wikipedia page has."
    ),
    ...
    _react2.default.createElement(
      "p",
      null,
      "We also visited a school for orphans between 3-8 years old, run by ",
      _react2.default.createElement(
        "a",
        { href: "http://www.littleangelsuganda.org/" },
        "Little Angels Uganda"
      ),
      ". We sat in on a class doing lessons for addition, subtraction, multiplication and spelling. We even got to get up do a bit of teaching ourselves, and nearly everything that happened in the class was followed by a song all the kids sang: \"(name), you're so good and precious\". It was pretty adorable."
    ),
    ...
    _react2.default.createElement(
      "p",
      null,
      "That last night in Uganda we set up a mini-cinema around Steve's laptop and watched ",
      _react2.default.createElement(
        "a",
        { href: "http://www.imdb.com/title/tt0395169/" },
        "Hotel Rwanda"
      ),
      ", which is almost like an African Schindler's list. I'll admit my knowledge of the full extent of what happened in Rwanda way back when I was a child was pretty lacking, having a bit of context the night before we were crossing into Rwanda worked out perfectly for me."
    ),
    _react2.default.createElement(
      "p",
      null,
      "The next day we were headed on to Rwanda for the trip highlight, tracking the mountain gorillas, but you'll probably have to wait months to read about that at the rate I'm going writing this stuff up :P Also, if you're interested there's loads more photos for each blog post up on ",
      _react2.default.createElement(
        "a",
        { href: "http://www.flickr.com/photos/lucasthenomad/sets" },
        "Flickr"
      ),
      " (and Facebook), but these posts are probably already way too photo-heavy."
    )
  );
  var blogPages = [];
