...
/***/ function(module, exports, __webpack_require__) {
  ...
  var body = exports.body = _react2.default.createElement(
    ...
    _react2.default.createElement(
      "p",
      null,
      "After breakfast we headed up to Nottingham castle for the event that drew me to England at this time, ",
      _react2.default.createElement(
        "a",
        { href: "http://www.beerfestival.nottinghamcamra.org/" },
        "The Robin Hood Beer Festival"
      ),
      ". It's a \"real ale\" festival run by ",
      _react2.default.createElement(
        "a",
        { href: "http://www.camra.org.uk/" },
        "CAMRA"
      ),
      ", offering over 1,100 casks of ale to sample, and about 300 ciders for those with no taste (Sorry Amanda :P). They had 900 casks of ale tapped at any one time, with the others \"settling\" so that when they're tapped they pour clear instead of being cloudy with too much yeast."
    ),
    ...
    _react2.default.createElement(
      "p",
      null,
      "We left the festival in the early evening and made a stop in at ",
      _react2.default.createElement(
        "a",
        { href: "http://en.wikipedia.org/wiki/Ye_Olde_Trip_To_Jerusalem" },
        "Ye Old Trip To Jerusalem"
      ),
      ", one of several pubs that claims to be the oldest in the UK. They claim to have been serving beer there since 1189AD. The pub is partly carved out of a sandstone cave, giving it a cosy atmosphere. It's mind-blowing to think that people have been drinking at that same venue for almost 1000 years."
    ),
    ...
    _react2.default.createElement(
      "p",
      null,
      "My favourite beer of the festival was ",
      _react2.default.createElement(
        "a",
        { href: "http://www.bateman.co.uk/our+brewery/our+beers/speciality+cask+beers" },
        "Bateman's Hazelnut Brownie"
      ),
      "; a sweet, rich syrupy beer with delicious chocolaty aroma. The name was pretty much spot on describing how it smelt and tasted. It was not a session beer, but it was nice to have a small glass of."
    ),
    ...
    _react2.default.createElement(
      "p",
      null,
      "We spent the morning touring around Bristol some more, checking out the immense amounts of great street art that decorates the city. I highly recommend checking out the ",
      _react2.default.createElement(
        "a",
        { href: "http://www.flickr.com/photos/lucasthenomad/sets/72157641676939995/" },
        "Flickr gallery for this post"
      ),
    ...
    _react2.default.createElement(
      "p",
      null,
      "The next morning Matty made us an epic breakfast for lunch, then we set out to make one last visit to all the pubs in town before I left. In at Brewdog we had a nip of ",
      _react2.default.createElement(
        "a",
        { href: "http://www.brewdog.com/blog-article/214" },
        "Tactical Nuclear Penguin"
      ),
      "each; one of their rarer, strong (32%), exotic and expensive drops.  Thankfully at the Brewdog bars at least they'll sell by the 30ml, instead of having to buy a 330ml bottle. It was superb, but it is an impossible beer to follow as the flavour is just so intense."
    ),
    _react2.default.createElement(
      "p",
      null,
