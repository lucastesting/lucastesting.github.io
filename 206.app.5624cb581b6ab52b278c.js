...
/***/ function(module, exports, __webpack_require__) {
  ...
  var body = exports.body = _react2.default.createElement(
    ...
    _react2.default.createElement(
      "p",
      null,
      "Luke and I had a \"small\" night out where we went over the road to the bar across from where we were staying for a few quiet beers, which lead to a lot of very noisy beers, which somehow led to us cranking",
      _react2.default.createElement(
        "a",
        { href: "https://soundcloud.com/neelix" },
        "Neelix"
      ),
      " over the bar sound system, the bar tender rocking out to it, me breaking out the poi and attracting some locals to come and watch the spectacle."
    ),
