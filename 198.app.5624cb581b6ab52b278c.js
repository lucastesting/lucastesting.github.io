...
/***/ function(module, exports, __webpack_require__) {
  ...
  var body = exports.body = _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "a",
        { href: "http://herecomestheplanet.com" },
        "Amanda and Luke"
      ),
      " that Seville doesn't really live up to it's reputation and I have to agree. Nothing we visited on the tour really stood out for me, so here's a token photo of Plaza de España with all the water drained out."
    ),
    ...
    _react2.default.createElement(
      "p",
      null,
      "They did however recommend a fancy tapas place called ",
      _react2.default.createElement(
        "a",
        { href: "http://laazoteasevilla.es/" },
        "La Azotea"
      ),
      " which was absolutely fantastic. I had some smoked cheese, cooked wild mushrooms, and pork cheek; and all of it was amazing. It was hands down the nicest tapas I came across; so good that I came back again for dinner the same day."
    ),
    ...
    _react2.default.createElement(
      "p",
      null,
      "In the evening I went and explored one of the stranger, modern attractions of Seville: The Metropol Parasol. It's a huge wooden structure, several stories high, apparently the largest wooden structure in the world. It looks kind of like those ",
      _react2.default.createElement(
        "a",
        { href: "https://www.google.com/search?q=wood+dinosaur+kit&tbm=isch" },
        "wooden dinosaur kits"
      ),
      " you'd beg for at museums when you were a kid (or was that just me?), except instead of a dinosaur they got some crazy mushroom looking thing."
    ),
