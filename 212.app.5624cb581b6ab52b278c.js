...
/***/ function(module, exports, __webpack_require__) {
  ...
  var intro = exports.intro = _react2.default.createElement(
    ...
    _react2.default.createElement(
      "p",
      null,
      "So after leaving Tanzania we were destined for Kenya to visit the Masai Mara, however we ran into a bit of trouble actually getting into Kenya. Everyone's visa got sorted out nice and quickly, but there was some sort of hold up involving the truck. Something to do with the truck's registration being changed over from English to Namibian and us not having the right ",
      _react2.default.createElement(
        "a",
        { href: "http://en.wikipedia.org/wiki/Carnet_de_Passages" },
        "Carnet de Passage"
      ),
      " to go with it."
    ),
